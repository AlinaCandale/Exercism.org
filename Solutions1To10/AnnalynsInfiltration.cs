    ...
    static class AnnalynsInfiltration
    {
        ...
        public static bool CanSpy(bool knightIsAwake, bool archerIsAwake, bool prisonerIsAwake)
        {
            if ((knightIsAwake == false || archerIsAwake == false) && prisonerIsAwake == true ||
               (knightIsAwake == false || prisonerIsAwake == false) && archerIsAwake == true ||
               (archerIsAwake == false || prisonerIsAwake == false) && knightIsAwake == true || archerIsAwake == prisonerIsAwake == knightIsAwake == true)
            {
                return true;
            }
        ...
        public static bool CanFreePrisoner(bool knightIsAwake, bool archerIsAwake, bool prisonerIsAwake, bool petDogIsPresent)
        {
            if ((petDogIsPresent == true && archerIsAwake == false) ||
               (prisonerIsAwake == true && knightIsAwake == false && archerIsAwake == false && petDogIsPresent == false))
            {
                return true;
            }
...
The game's main character is Annalyn, a brave girl with a fierce and loyal pet dog. Unfortunately, disaster strikes, 
as her best friend was kidnapped while searching for berries in the forest.
